...
//         setJourneyData(prev => ({ ...prev, dropoffs: [...prev.dropoffs, ""] }));
//     };
...
//                 {
//                     text: "OK", onPress: () => {
//                         const updated = [...journeyData.dropoffs];
//                         updated.splice(index, 1);
//                         const newDropoffs = updated.length ? updated : [""];
//                         setJourneyData(prev => ({ ...prev, dropoffs: newDropoffs }));
